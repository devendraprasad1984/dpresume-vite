...
import {ISwaggerConfig, Swagger} from "fnpm/swagger";
import {Chat} from "fnpm/chat";
import {StreamApi} from "fnpm/chat/stream";
import {ClientType as StreamClientType} from "fnpm/chat/stream/enum";
...
/**
 * Auth service/function interface
 */
interface IAuth {
    // properties
...
export class Auth implements IAuth {
     ...
     * @param {Routes} routes routes dependency
     */
    constructor(
    ...
    start(): Server {
        ...
        console.info(`Auth service API Docs are running on http://localhost:${port}/auth/api-docs`);
        return this._server;
    }
