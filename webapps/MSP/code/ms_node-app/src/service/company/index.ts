...
/**
 * Company service/function interface
 */
interface ICompany {
    // properties
...
export class Company implements ICompany {
    ...
    start(): Server {
        ...
        console.info(`Company service API Docs are running on http://localhost:${port}/company/api-docs`);
