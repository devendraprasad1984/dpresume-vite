...
/**
 * Conversation service/function interface
 */
interface IMessage {
    // properties
...
/**
 * Class derived from IConversation
 */
@injectable()
export class Message implements IMessage {
    ...
    start(): Server {
        ...
        console.info(`Message service API Docs are running on http://localhost:${port}/message/api-docs`);
