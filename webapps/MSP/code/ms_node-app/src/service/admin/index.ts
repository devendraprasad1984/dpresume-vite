...
/**
 * Admin service/function interface
 */
interface IAdmin {
    // properties
...
export class Admin implements IAdmin {
    ...
    start(): Server {
        ...
        console.info(`Admin service API Docs are running on http://localhost:${port}/admin/api-docs`);
    ...
    private setSwagger(): void {
        new Swagger(this._xprs, {
            ...
            contact: {
                name: this.config.info.contact.name,
                url: this.config.info.contact.url
            },
            service: {
